...
readWB = opx.load_workbook(r"C:\Users\VD102541\Desktop\VictorDummyData.xlsx", data_only=True) #Workbook used to read data. Does not interpret or 
                                                                                                            #translate any formulas.

writeWB = opx.load_workbook(r"C:\Users\VD102541\Desktop\VictorDummyData.xlsx", data_only=False) #Workbook used to write data to new file. Interprets 
